 ...
 */
class getClientRecordRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ClientRecordRepository' shared autowired service.
     *
     * @return \App\Repository\ClientRecordRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ClientRecordRepository.php';

        return $container->privates['App\\Repository\\ClientRecordRepository'] = new \App\Repository\ClientRecordRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
