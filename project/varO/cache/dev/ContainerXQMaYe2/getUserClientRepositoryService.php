 ...
 */
class getUserClientRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserClientRepository' shared autowired service.
     *
     * @return \App\Repository\UserClientRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserClientRepository.php';

        return $container->privates['App\\Repository\\UserClientRepository'] = new \App\Repository\UserClientRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
